...
public class RecentLogsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_NORMAL) {
            View view = inflater.inflate(R.layout.recent_logs_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof LogsViewHolder) {
            ...
            ((EmptyViewHolder) holder).bindEmpty();
        }
    }
    ...
    public static class LogsViewHolder extends RecyclerView.ViewHolder {
        private final ImageView logsIcon;
        private final TextView actionLabel;
        private final TextView actionCategory;
        private final TextView logsTimestamp;
