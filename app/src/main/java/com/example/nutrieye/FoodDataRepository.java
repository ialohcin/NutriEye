...
public class FoodDataRepository {
    ...
    private static void initFoodMap() {
        ...
        //Cooked Dishes
        foodMap.put("Beef Kaldereta", new FoodData("Cooked Dishes", 100,250, 5.2, 17, 22, 3.5, 1, 60, 25, 0.2, 0.3, 30, 20, 750, 3.5));
        foodMap.put("Beef Kare-Kare", new FoodData("Cooked Dishes", 100,220, 3.8, 15, 20, 2.5, 2, 65, 15, 0.2, 0.4, 20, 30, 600, 3.0));
        foodMap.put("Beef Ribs Sinigang", new FoodData("Cooked Dishes", 100,180, 2.5, 12, 18, 2, 1, 70, 10, 0.2, 0.3, 25, 20, 600, 2.5));
        foodMap.put("Bulalo", new FoodData("Cooked Dishes", 100,250, 4, 16, 20, 1.5, 0, 65, 10, 0.2, 0.4, 15, 15, 700, 3.0));
        foodMap.put("Chicken Adobo", new FoodData("Cooked Dishes", 100,180, 1, 12, 20, 1, 0, 65, 5, 0.1, 0.2, 10, 10, 600, 2.0));
        foodMap.put("Chicken Afritada", new FoodData("Cooked Dishes", 100,200, 2.5, 14, 18, 2, 1, 70, 10, 0.2, 0.3, 15, 15, 650, 2.5));
        foodMap.put("Chicken Inasal", new FoodData("Cooked Dishes", 100,190, 1.5, 10, 22, 1, 0, 65, 8, 0.2, 0.2, 8, 10, 600, 2.0));
        foodMap.put("Chicken Tinola", new FoodData("Cooked Dishes", 100,150, 1.8, 8, 20, 1, 1, 75, 10, 0.1, 0.2, 12, 12, 550, 1.8));
        foodMap.put("Crispy Pata", new FoodData("Cooked Dishes", 100, 350, 0, 30, 18, 0, 0, 50, 0, 0, 0, 0, 0, 800, 4.0));
        foodMap.put("Pork Barbeque", new FoodData("Cooked Dishes", 100, 280, 10, 20, 18, 8, 0, 50, 4, 0.2, 0.3, 6, 8, 650, 3.0));
        foodMap.put("Pancit Canton", new FoodData("Cooked Dishes", 100, 220, 25, 10, 15, 2, 2, 60, 2, 0.1, 0.2, 8, 10, 550, 2.5));
        foodMap.put("Pork Menudo", new FoodData("Cooked Dishes", 100, 200, 4, 12, 16, 2, 2, 65, 6, 0.2, 0.3, 10, 15, 600, 2.5));
        foodMap.put("Shrimp Sinigang", new FoodData("Cooked Dishes", 100, 120, 2, 8, 18, 1, 1, 75, 20, 0.2, 0.3, 20, 25, 700, 2.0));
